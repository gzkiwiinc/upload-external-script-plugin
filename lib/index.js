...
var UploadExternalScriptPlugin = (function () {
    ...
    UploadExternalScriptPlugin.prototype.initClient = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, region, accessKeyId, accessKeySecret, securityToken, expiration;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(!this.client || Date.now() > this.authExpiration)) return [3, 2];
                        return [4, requestOSSData()];
                    case 1:
                        _a = _b.sent(), region = _a.region, accessKeyId = _a.accessKeyId, accessKeySecret = _a.accessKeySecret, securityToken = _a.securityToken, expiration = _a.expiration;
